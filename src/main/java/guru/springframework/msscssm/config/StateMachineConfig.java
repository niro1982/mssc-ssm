...
public class StateMachineConfig extends StateMachineConfigurerAdapter<PaymentState, PaymentEvent> {
    ...
    //state machine action is where we can do a lot of different things like write to DB, send event, web service etc.
    //its where we can implement business logic
